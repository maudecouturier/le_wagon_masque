...
squelette = Costume.new(title:"Squelette", user: lea, description: "déguisement de conte de fée sexy", location: "rue de Tolbiac", price: 15, size: "S", gender: "F", theme: "fairy-tales")
...
muerte = Costume.new(title:"Dia de los muerte", user: jeanne, description: "déguisement muerte bébé", location: "Villa Gaudelet", price: 15, size: "XS", gender: "M", theme: "animals")
...
batman = Costume.new(title:"Batman", user: julien, description: "déguisement pour les soirées du batman", location: "Champs-Elysées", price: 30, size: "M", gender: "M", theme: "other")
...
casapapel = Costume.new(title:"Braqueur de banque", user: julien, description: "Casa de papel", location: "51 rue des Renaudes, Paris", price: 30, size: "M", gender: "M", theme: "pirates")
...
hercule = Costume.new(title:"Hercule", user: julien, description: "Casa de papel", location: "Tour-eiffel", price: 30, size: "M", gender: "M", theme: "comics")
...
=======
booking_1 = Booking.create!(user: charles, costume: batman, start_date: Date.new(2019,10,1), end_date: Date.new(2019,10,3))
booking_2 = Booking.create!(user: jeanne, costume: casapapel, start_date: Date.new(2010,01,12), end_date: Date.new(2020,01,15))
booking_3 = Booking.create!(user: lea, costume: astronaut, start_date: Date.new(2019,10,31), end_date: Date.new(2019,11,2))
>>>>>>> 93ec90bd226ba9eaa08cd8ca6379984e59989d1a
