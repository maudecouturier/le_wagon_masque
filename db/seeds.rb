...
pirate = Costume.new(title:"pirate", user: jeanne, description: "Déguisement d'homme pirate", location: "Paris", price: 20, size: "M", gender: "M", theme: "pirates")
...
princesse = Costume.new(title:"princesse", user: lea, description: "déguisement de conte de fée sexy", location: "Limoges", price: 15, size: "S", gender: "F", theme: "fairy-tales")
...
mouton = Costume.new(title:"mouton", user: jeanne, description: "déguisement mouton bébé", location: "Lille", price: 15, size: "XS", gender: "M", theme: "animals")
...
wagon = Costume.new(title:"wagon", user: julien, description: "déguisement pour les soirées du wagon", location: "Paris", price: 30, size: "M", gender: "M", theme: "other")
